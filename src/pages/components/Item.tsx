...
const Item: React.FC<ItemProps> = ({img, id, title, price}) => {
    ...
    return (
        <motion.div
        onClick={() => push('tour/1213')}
        initial='hidden'
        whileInView='visible'
        viewport={{ amount: 0.4, once: true}}
        variants={animation}
        className={`gradient relative bg-center aspect-[1/1.33] bg-full flex flex-col justify-end items-center lg:hover:bg-org duration-300 lg:cursor-pointer`} style={{backgroundImage: `url("/images/toursImage/${img}")`}}>
