...
const Footer: React.FC<FooterProps> = () => {
    ...
    return (
        <footer className='px-[15px] py-[27px] flex flex-col items-center space-y-[20px]'>
            <img src="/images/logo.png" className='h-[80px]' alt="" />
            <nav className='space-y-[5px]'>
                <p className="text-[#fff] text-[14px] text-center">{lang.header.about}</p>
                <p className="text-[#fff] text-[14px] text-center">{lang.header.services}</p>
                <p className="text-[#fff] text-[14px] text-center">{lang.header.employees}</p>
            </nav>
