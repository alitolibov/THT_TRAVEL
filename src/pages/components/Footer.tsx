        ...
        viewport={{ amount: 0.2, once: true}}
         className='px-[15px] py-[27px] flex flex-col items-center space-y-[20px] md:px-[25px] lg:flex-row lg:justify-between xl:px-[0] xl:w-[1250px] xl:mx-auto'>
            ...
            <motion.nav custom={1} variants={animation} className='space-y-[5px] md:space-y-[7px]'>
                ...
                <a href='#' className="block text-[#fff] text-[14px] text-center md:text-[16px] lg:cursor-pointer lg:hover:text-[var(--main-color-two)] duration-500 lg:text-left lg:text-[17px]">{lang.header.services}</a>
                <a href='#' className="block text-[#fff] text-[14px] text-center md:text-[16px] lg:cursor-pointer lg:hover:text-[var(--main-color-two)] duration-500 lg:text-left lg:text-[17px]">{lang.header.employees}</a>
            </motion.nav>
