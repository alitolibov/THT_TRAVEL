...
export default {
    ...
    dynamicPage: {
        ...
        bookForm: {
            ...
            {
                title: 'Safar uchun qanday hujjatlarga ega bolishim kerak?', desc: "Xalqaro sayohat uchun sizga viza, pasport va, ehtimol, tibbiy sug'urta kerak bo'ladi. Batafsil ko'rsatmalar bronlash paytida taqdim etiladi.."
            },
            {
                title: "Qo'shimcha tunlarni qo'shishim mumkinmi?", desc: "Ha, qo'shimcha tunlarni qo'shish orqali qolish vaqtingizni uzaytirishingiz mumkin. Ushbu variantni muhokama qilish uchun biz bilan bog'laning."
            },
            {
                title: "Parvozni bekor qilish yoki kechiktirish qoidalari qanday?",
                desc: "Bekor qilish va parvozni kechiktirish siyosati aviakompaniyaga qarab farq qiladi. Aviakompaniya veb-saytidagi qoidalar va tavsiyalar bilan tanishishingizni yoki qo'shimcha ma'lumot olish uchun biz bilan bog'lanishingizni tavsiya qilamiz."
            }
        ]
    }
}