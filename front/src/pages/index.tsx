...
const Main: React.FC<MainProps> = () => {
    ...
    return (
        ...
        variants={{ visible: { transition: { staggerChildren: 0.4 } } }}>
            ...
            <motion.h1 variants={{hidden, visible}} className='font-[700] text-[36px] text-white leading-[44px] w-[285px] md:text-[45px] md:leading-[55px] md:w-[360px] lg:text-[60px] lg:leading-[75px] lg:w-[480px] xl:text-[72px] xl:leading-[85px] xl:w-[580px]'>{t('header.greetings')}</motion.h1>
